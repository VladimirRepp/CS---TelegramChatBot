...
{
    internal class ByeRplayCommandResponder_ChatCommand : BaseChatCommand
    {
        public Message Message;
        public User User;

        public ByeRplayCommandResponder_ChatCommand(TelegramBotClient client, Update update = null, string name = null) :
       base(client, update)
        {
        ...
        public override async Task ExecuteAsync()
        {
            await BotClient.SendMessage(
                           Chat.Id,
                           $"До встречи, {this.User.FirstName}!",
