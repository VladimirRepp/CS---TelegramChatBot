...
namespace TelegramChatBot.Pages
{
    ...
    {
        // === Chat Commands === //
        private CreateStartBotCommands_ChatCommand _createStartBotCommands_CC;
        ...
        public TestPage(int id, TelegramBotClient client, string name = "") : base(id, client)
        {
            ...
            _createStartBotCommands_CC = new(client);
        ...
        {
            await _createStartBotCommands_CC.ExecuteAsync();
