...
namespace TelegramChatBot.Handlers
{
    public class UpdateHandler
    {
        ...
        public UpdateHandler(MessageHandler messageHandler, CallbackQueryHandler callbackQueryHandler, CommandHandlerManager commandHandler)
        {
        ...
        private async Task ProcessUserMessageRequest(long userId, ITelegramBotClient botClient, Update update)
        {
            ...
            await _messageHandler.HandleMessageAsync(userId, botClient, update);
        }
        ...
        private async Task ProcessUserCallbackRequest(long userId, ITelegramBotClient botClient, Update update)
        {
            ...
            await _callbackQueryHandler.HandleCallbackAsync(userId, botClient, update);
        }
