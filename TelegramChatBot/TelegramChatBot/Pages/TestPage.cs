...
namespace TelegramChatBot.Pages
{
    internal class TestPage : IPage
    {
        ...
        public TestPage(int id, TelegramBotClient client, string name = "")
        {
            _id = id;
            _botClient = client;
        ...
        public async Task OnCallbackQueryHandler(Update update)
        {
        ...
        public async Task OnMessageHandler(Update update)
        {
